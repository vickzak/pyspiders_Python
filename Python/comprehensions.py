...
# l=[3,1,2,0,6,7,2]
# # r=lambda l:[ i**2 if i%2==0 else i for i in l ]
# # print(r(l))

# r=lambda i:i**2 if i%2==0 else i
# # b=map(r,l)
# print(list(filter(map(r,l),l)))
...
# r=lambda a:[ "pal" if a==a[::-1] else "not pal" ]
# print(r('abrar'))
